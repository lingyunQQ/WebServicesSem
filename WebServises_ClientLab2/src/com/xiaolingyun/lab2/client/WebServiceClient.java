package com.xiaolingyun.lab2.client;
/**
...
import com.xiaolingyun.lab2.generated.BeautyProduct;
import com.xiaolingyun.lab2.generated.BeautyProductService;
...
public class WebServiceClient {
    ...
    private static void insertBeautyProduct(BufferedReader br) throws IOException
    {
        ...
        Integer id = beautyProductService.getBeautyProductWebServicePort().insertBeautyProduct(name, producingСountry, vendorСode, category, price);
        if (id >= 0)
    ...
    private static void updateBeautyProduct(BufferedReader br) throws IOException
    {
        ...
        String status = beautyProductService.getBeautyProductWebServicePort().updateBeautyProduct(id, name, producingСountry, vendorСode, category, price);
