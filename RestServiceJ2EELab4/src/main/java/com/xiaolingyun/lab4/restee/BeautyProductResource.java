...
public class BeautyProductResource {
	...
	public List<BeautyProduct> getPersons(@QueryParam("id") String id, @QueryParam("name") String name,
		...
		if ((id == null || id.isEmpty()) && (name == null || name.isEmpty())
			...
			List<BeautyProduct> beautyProducts = new PostgreSQLDAO(getConnection()).getBeautyProducts();
		...
		List<BeautyProduct> beautyProducts = new PostgreSQLDAO(getConnection()).findBeautyProduct(id, name,
